...
% Parameters
  NA = 2.8e3;             % Initial number of A cells
  NB = 3e3;             % Initial number of B cells
  Nt = 80;             % total number of time steps (assumed days)
...
%% Plotting 
   ...
   legend("ST-HSCs")
   legend('Active', 'Quiescent', 'Inactive','Total','Quiescent + Inactive','paper')
   title('ST-HSCs')
   ax = gca; ax.FontSize=28; ax.LineWidth=1.5;
   %yscale log
